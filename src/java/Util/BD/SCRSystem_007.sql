...
create table solicitacao (
	...
	datahora_solicitacao bigint not null,
	datahorainicioutilizacao_solicitacao bigint not null,
...
create table participante (
	...
	vinculo_participante varchar(50) not null,
...
INSERT INTO administrador(
    ...
    VALUES ('Murilo da Secretaria', 'murilo@etec.sp.gov.br', '123456', false);

INSERT INTO administrador(
            nome_administrador, emailinstitucional_administrador, 
            senha_administrador, permissaoaprovacao_administrador)
    VALUES ('Matheus da Direção', 'matheus@etec.sp.gov.br', '123456', true);